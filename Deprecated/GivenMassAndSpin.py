...
def minimize_given_mass_and_spin(strain_data = Yl2m2, A =.75, M = 1):
    ...
    signal = np.stack((strain_data[start_frame:end_frame,2] , strain_data[start_frame:end_frame,1]))
    ...
    def Residuals(x, params0, params1, params2):
        ...
        return residuals
    # Define the way the parameters to be fit are used to construct a trial solution to
